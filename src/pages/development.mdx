...
# Deploy Prisma
# If you have issues running this command, try adding the --dry flag
prisma deploy
...
```js
// You can also use environmental variables (recommended in production!)
